...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { Asunto: @contacto.Asunto, Body: @contacto.Body, Email: @contacto.Email, Nombre: @contacto.Nombre }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { Asunto: @contacto.Asunto, Body: @contacto.Body, Email: @contacto.Email, Nombre: @contacto.Nombre }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
